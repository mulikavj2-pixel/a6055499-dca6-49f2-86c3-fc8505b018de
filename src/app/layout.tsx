...
export const metadata: Metadata = {
  ...
  description: "Handcrafted specialty coffee and warm hospitality. Visit our cafe for the perfect brew, single-origin beans, and cozy atmosphere.",
  keywords: "coffee shop, specialty coffee, espresso, cappuccino, cafe, premium coffee",
  ...
  openGraph: {
    title: "Brew & Bean - Premium Coffee Shop",
    description: "Discover handcrafted specialty coffee and join thousands of satisfied customers.",
    type: "website",
    siteName: "Brew & Bean",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765812671731-a475grt2.jpg",
  ...
  twitter: {
    ...
    title: "Brew & Bean - Premium Coffee Shop",
    description: "Discover handcrafted specialty coffee and join our coffee community.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765812671731-a475grt2.jpg"]
  },
  robots: {
    index: true,
    follow: true
